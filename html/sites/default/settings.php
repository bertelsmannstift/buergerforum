 ...
 *
 */
$drupal_hash_salt = 'okDG69Ym91o8PWMI6yyu9Fh1wYn2tDJZcZkfSHuV9Kw';
...
if (file_exists(DRUPAL_ROOT . '/sites/all/translations/translations.php')) {
  require_once DRUPAL_ROOT . '/sites/all/translations/translations.php';
}
