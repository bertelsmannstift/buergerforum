...
<div class="flag-outer flag-outer-<?php print $flag_name_css; ?>">
  ...
  <?php if ($link_href): ?>
    <a href="<?php print $link_href; ?>" title="<?php print $link_title; ?>" class="<?php print $flag_classes ?>" rel="nofollow"><?php print $flag->get_count($entity_id); ?></a><span class="flag-throbber">&nbsp;</span>
  <?php else: ?>
